...
```
If you need to deal with actual amounts not percentages you can use the -a option in buyAsset.sh or sellAsset.sh to execute market buy/sells.

The following buys 40 dollars worth of AAVE with your USDC balance.
